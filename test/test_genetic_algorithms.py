...
from genetic_algorithm import weight_by, reproduce, mutate, genetic_algorithm
...
class TestEvolutionaryAlgorithm(TestCase):
    ...
    def test_reproduce(self):
        ...
        with self.subTest(fp=fp, sp=sp, e=e, c=c):
            with patch("genetic_algorithm.random.randrange", return_value=c):
    ...
    def test_mutate(self):
        ...
        with patch.multiple("genetic_algorithm.random", uniform=DEFAULT, randrange=DEFAULT, choice=DEFAULT) as mocks:
